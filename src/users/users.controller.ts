...
export class UsersController {
  ...
  @Post()
  async createUser(@Body() createUserDto: CreateUserDto): Promise<ISuccessResponse> {
  ...
  @Post('create-admin')
  async createAdmin(@Body() createUserDto: CreateUserDto, @Request() req: IRequest): Promise<ISuccessResponse> {
  ...
  @Auth(ADMIN_PERMISSION)
  @Put(':id')
  async adminUpdateUser(@Body() adminUpdateUserDto: AdminUpdateUserDto, @Param('id', ParseIntPipe) id: number): Promise<ISuccessResponse> {
  ...
  @Auth(SUPER_ADMIN_PERMISSION)
  @Delete(':id')
  async adminDeleteUser(@Param('id', ParseIntPipe) id: number): Promise<ISuccessResponse> {
